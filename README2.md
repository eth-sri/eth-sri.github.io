...
```yaml
  disqus:
    shorttitle: my_disqus_shortname
```
...
```yaml
twitter_usertitle: jekyllrb
github_usertitle:  jekyll
dribbble_usertitle: jekyll
facebook_usertitle: jekyll
flickr_usertitle: jekyll
instagram_usertitle: jekyll
linkedin_usertitle: jekyll
pinterest_usertitle: jekyll
youtube_usertitle: jekyll
googleplus_usertitle: +jekyll
rss: rss
