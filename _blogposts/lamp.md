...
<br><br>
We see that despite the worse quality of reconstruction, even batch size of 4 still leaks a substaintial amount of data. Further, we observe that for bigger batch sizes LAMP<sub>L1+L2</sub> performs better than LAMP<sub>cos</sub>. Both LAMP methods, however, substantially improve upon the results of the baselines.
